...
class BindingTests extends TestGroupBase 
{
  ...
  void oneWayBindingUnRegister(){
    ...
    Expect.equals(1, e1._bindings.length);
    ...
    Expect.equals(0, e1._bindings.length);
  ...
  void twoWayBindingUnRegister(){
    ...
    Expect.equals(0, e1._bindings.length, "e1");
    Expect.equals(0, e2._bindings.length, "e2");
    ...
    Expect.equals(1, e1._bindings.length, "e1");
    Expect.equals(1, e2._bindings.length, "e2");
    ...
    Expect.equals(0, e1._bindings.length);
    Expect.equals(0, e2._bindings.length);
  }
