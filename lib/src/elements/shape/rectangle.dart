...
class Rectangle extends Shape{
  ...
  _initShapeProperties(){
    ...
    strokeWidth = new AnimatingFrameworkProperty(this, 'strokeWidth',
      'border-thickness',
      propertyChangedCallback: (value){
        String color = stroke.value != null ? '${stroke.value}' : Colors.White.toString();
    ...
    stroke = new AnimatingFrameworkProperty(this, 'stroke',
        'border-color',
        propertyChangedCallback: (value){
